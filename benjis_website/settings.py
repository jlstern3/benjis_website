"""
Django settings for benjis_website project.
...
SECRET_KEY = 's^j-qgcicaz_(kazrvk6#+^rw#f7jqoqsmt-pb&(@)3fr^2c)m'
...
ROOT_URLCONF = 'benjis_website.urls'
...
WSGI_APPLICATION = 'benjis_website.wsgi.application'
